...
int main(){
	...
	cout << "The company has to pay an amount of " << abc.totalSalary() << " VND per month to all employees." << endl;

	cout << "=======>>All employees with the highest salaries in the company" << endl;
	abc.printEmployeeWithHighestSalary();
